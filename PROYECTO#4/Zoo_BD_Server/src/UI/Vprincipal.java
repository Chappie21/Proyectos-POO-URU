...
public class Vprincipal extends JFrame implements ActionListener{
	...
	public Vprincipal() {
		...
		setLayout(null);
		setSize(308,300);/*TAMAÑO DE LA VENTANA*/
	...
	private void Elementos() {
		...
		b3.setBounds(155,165,140,100);
		b4.setBounds(10,165,140,100);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==back) {
			back.setVisible(false);
			Cambiar(308,300,principal);/*CADA VEZ QUE EL USUARIO PRESIONE EL BOTON VOLVER 
